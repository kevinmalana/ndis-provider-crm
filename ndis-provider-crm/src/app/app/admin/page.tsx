...
export default async function AdminPage() {
  ...
  const [participants, cards, memberships, shifts, assignments, authorities, grants, consents, availability, audit, identities, selfLinks, serviceContexts, providerScopes, capabilities, catalogues, catalogueItems, roles, screeningPolicies, snapshots, ackLedger] = await Promise.all([
  ...
  const readError = [participants, cards, memberships, shifts, assignments, authorities, grants, consents, availability, audit, identities, selfLinks, serviceContexts, providerScopes, capabilities, catalogues, catalogueItems, roles, screeningPolicies, snapshots].find((result) => result.error)?.error;
  if (readError) {
